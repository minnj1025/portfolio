    ...
    figures: [
      {
        ...
        caption:
          "실제 동작 — 점 하나가 후보 부분집합 하나입니다. 가로축은 그 후보가 쓰는 모달리티 개수, 세로축은 다섯 개를 다 썼을 때 대비 예측 손실입니다. 점선 아래면 충분하고, 그중 가장 왼쪽이 선택됩니다. 2개만 써도 되는 클립부터 다섯 개가 전부 필요한 클립까지 차례로 나오며, 마지막은 절약할 수 없는 경우입니다. AIDE 피험자 보호를 위해 얼굴과 상반신은 흐리게 처리했습니다.",
        width: 1280,
        height: 720,
      },
      {
