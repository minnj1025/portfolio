...
export const projects: Project[] = [
  {
    ...
    approach: [
      ...
      },
      {
        name: "빗나가는 이유 찾기",
        detail:
          "'내 공간을 남과 나눠 써야 해서 불편하다'는 일기에, 아브람과 롯이 땅을 나눠 갈라서는 창세기 13장이 3,174개 중 352위였습니다. 반대로 '외롭다'처럼 주제가 곧 답인 일기는 1위로 올라옵니다. 갈리는 지점은 연결에 유추가 필요한가였습니다. 검색 기법을 더 붙여봐도 소용없었습니다. HyDE는 유사도를 0.348에서 0.602로 끌어올렸지만 가게 공간이 불편하다는 사람에게 이혼 본문을 줬고, 임베딩 모델 교체도 원래 쓰던 한국어 모델보다 못했습니다. 문제는 검색하는 방법이 아니라 색인에 담아둔 것이 '이 본문은 무엇에 관한 글인가'라는 제삼자의 요약이라는 데 있었습니다.",
      },
      {
        name: "색인 뒤집기",
        detail:
