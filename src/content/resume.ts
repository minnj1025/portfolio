...
export const internships: ResumeEntry[] = [
  {
    ...
    points: [
      "파이프라인 첫 단계인 뉴스 카테고리·중요도 분석 모듈을 단독 담당",
      "기업을 노드, 기업 간 관계를 엣지로 두는 통합 그래프 설계를 제안했으나 한 달 일정에 맞춰 세 모듈로 분리하는 쪽으로 방향을 조정",
      "뉴스의 주가 반응을 분석한 선행 연구에서 판정 기준을 가져와 루브릭으로 정리하고, 통과·기각 사례를 함께 제시해 LLM 판정의 출력 분산을 축소",
      "카테고리 4분류와 0~1 중요도 점수, 0.7 컷오프로 하위 모듈의 입력을 줄여 전체 LLM 호출 비용과 처리 시간도 함께 절감",
    ],
  },
];
